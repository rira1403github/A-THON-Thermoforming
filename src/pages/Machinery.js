...
const Machineries = () => {
  ...
  return (
    ...
    <section className="manufacturing-section" id="manufacturing">
      <h2 className="manufacturing-title" data-aos="fade-up">Manufacturing Capabilities</h2>
      ...
      <div className="manufacturing-grid">
        {[
          ...
          <div className="manufacturing-card" data-aos="zoom-in" data-aos-delay={index * 100} key={index}>
